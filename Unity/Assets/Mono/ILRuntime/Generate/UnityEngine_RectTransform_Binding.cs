...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_RectTransform_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_anchoredPosition3D_0);
            ...
            app.RegisterCLRMethodRedirection(method, set_anchoredPosition3D_2);
            args = new Type[]{};
            method = type.GetMethod("get_anchoredPosition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_anchoredPosition_3);


        }


        static StackObject* get_anchoredPosition3D_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_anchoredPosition3D_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_anchoredPosition_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
