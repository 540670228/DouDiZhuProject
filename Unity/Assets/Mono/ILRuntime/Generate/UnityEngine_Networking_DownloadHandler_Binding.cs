...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Networking_DownloadHandler_Binding
    {
        ...
        static StackObject* get_isDone_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Networking.DownloadHandler instance_of_this_method = (UnityEngine.Networking.DownloadHandler)typeof(UnityEngine.Networking.DownloadHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
