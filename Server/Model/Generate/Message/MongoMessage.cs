...
namespace ET
{
	...
	[ResponseType(nameof(M2M_UnitLTransferResponse))]
	[Message(MongoOpcode.M2M_UnitLTransferRequest)]
	[ProtoContract]
	public partial class M2M_UnitLTransferRequest: Object, IActorRequest
	{
		[ProtoMember(1)]
		public int RpcId { get; set; }

		[ProtoMember(2)]
		public UnitL UnitL { get; set; }
